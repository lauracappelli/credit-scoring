...
def monotonicity_constr_6(m, n, default, offset, mu=1):
...
def monotonicity_constr_alt(m, n, default, offset, mu=1):
    ...
    u4_alt = (
	(
	flatten_indices(item_c_set_minus_1[0],j),
	flatten_indices(item_c_set_minus_1[1],j),
	flatten_indices(item_c_set_minus_2[0],j),
	flatten_indices(item_c_set_minus_2[1],j)
	)
	for item_c_set_minus_1 in C_set_minus
	for item_c_set_minus_2 in C_set_minus
	for j in range(m - 1)
...
Q = monotonicity_constr_6(m, n, def_rand, offset, mu=1)
end1 = time.perf_counter_ns()

start2 = time.perf_counter_ns()
QQ = monotonicity_constr_alt(m, n, def_rand, offset, mu=1)
end2 = time.perf_counter_ns()

print(np.array_equal(Q, QQ))
print(end1-start1)
print(end2-start2)