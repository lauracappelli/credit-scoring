...
if n < 7:
	print("n < 7")
	print("setting low_thr = math.floor( math.floor(n/m) / 4 ) instead of math.ceil(n/100)")
	print("setting upp_thr = math.floor( (4/5)*(n - m + 1) ) instead of math.floor(15*n/100)")
	low_thr = math.floor( math.floor(n/m) / 4 )
...
if n < 100:
	...
	print("number of defaults math.floor(n/100) :", d)
...
if n < 7:
	print("4) of low thr using low thr = math.floor( math.floor(n/m) / 4 ):", dim_slack_low_th)
